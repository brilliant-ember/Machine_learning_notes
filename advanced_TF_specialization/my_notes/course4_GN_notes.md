...
the training loop for the GAN is different than usual netowrks since we have two networks to train.
Here are the steps:

1. Train the discremenator sepretly
